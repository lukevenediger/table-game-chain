...
const (
	Query_Params_FullMethodName  = "/tablegamechain.checkers.Query/Params"
	Query_Game_FullMethodName    = "/tablegamechain.checkers.Query/Game"
	Query_GameAll_FullMethodName = "/tablegamechain.checkers.Query/GameAll"
)
