...
import (
	...
	checkersmodulekeeper "table-game-chain/x/checkers/keeper"
	tablegamechainmodulekeeper "table-game-chain/x/tablegamechain/keeper"

	// this line is used by starport scaffolding # stargate/app/moduleImport

	"table-game-chain/docs"
)

const (
	AccountAddressPrefix = "table"
	Name                 = "table-game-chain"
)
...
type App struct {
	*runtime.App
	...
	TablegamechainKeeper tablegamechainmodulekeeper.Keeper
